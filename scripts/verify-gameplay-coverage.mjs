...
addCheck('cocos shared rules verification command', 'package.json', ['verify:rules', 'verify:cocos-project', 'verify:cocos-simulation', 'verify:textures && npm run verify:cocos-project && npm run verify:rules && npm run verify:cocos-simulation']);
...
addCheck('cocos simulation verification command', 'package.json', ['verify:cocos-simulation', 'verify:rules && npm run verify:cocos-simulation && npm run verify:gameplay']);
