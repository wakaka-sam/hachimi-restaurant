...
addCheck('cocos shared rules verification command', 'package.json', ['verify:rules', 'verify:cocos-project', 'verify:textures && npm run verify:cocos-project && npm run verify:rules']);
