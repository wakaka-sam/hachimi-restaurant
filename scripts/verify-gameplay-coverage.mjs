...
addCheck('cocos shared rules verification command', 'package.json', ['verify:rules', 'verify:cocos-project', 'verify:cocos-api', 'verify:cocos-simulation', 'verify:cocos-components', 'verify:cocos-controller', 'verify:textures && npm run verify:cocos-project && npm run verify:rules && npm run verify:cocos-api && npm run verify:cocos-simulation && npm run verify:cocos-components && npm run verify:cocos-controller']);
