...
const expectedTextureDimensions = {
  ...
  'design-nav-restaurant.png': [720, 105],
  'design-nav-tasks.png': [720, 105],
  'design-nav-upgrade.png': [720, 105],
  'design-restaurant-scene.png': [720, 470],
  'design-start-button.png': [380, 96],
  'design-task-board.png': [672, 800],
  'design-task-heading.png': [432, 100],
  'design-title-sign.png': [572, 118],
  'design-upgrade-board.png': [648, 800],
  'design-upgrade-button-green.png': [124, 82],
  'design-upgrade-button-locked.png': [310, 84],
  'design-upgrade-full.png': [720, 1280],
  'design-upgrade-heading.png': [420, 90],
  'design-upgrade-icon-cashier.png': [140, 116],
  'design-upgrade-icon-chair.png': [140, 116],
  'design-upgrade-icon-floor.png': [140, 116],
  'design-upgrade-icon-table.png': [140, 116],
  'design-upgrade-icon-wall.png': [140, 116],
